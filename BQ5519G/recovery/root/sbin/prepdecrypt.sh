...
venpath="/dev/block/platform/soc/soc:ap-ahb/20600000.sdio/by-name/vendor$suffix"
mkdir /v
mount -t ext4 -o ro "$venpath" /v

syspath="/dev/block/platform/soc/soc:ap-ahb/20600000.sdio/by-name/system$suffix"
mkdir /s
